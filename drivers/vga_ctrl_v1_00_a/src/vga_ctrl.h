/*****************************************************************************
* Filename:          D:\RA92-2016\lab3/drivers/vga_ctrl_v1_00_a/src/vga_ctrl.h
* Version:           1.00.a
...
#define VGA_CTRL_SLV_REG1_OFFSET (VGA_CTRL_USER_SLV_SPACE_OFFSET + 0x00000004)
#define VGA_CTRL_SLV_REG2_OFFSET (VGA_CTRL_USER_SLV_SPACE_OFFSET + 0x00000008)
#define VGA_CTRL_SLV_REG3_OFFSET (VGA_CTRL_USER_SLV_SPACE_OFFSET + 0x0000000C)
...
#define VGA_CTRL_mWriteSlaveReg1(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_CTRL_SLV_REG1_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_CTRL_mWriteSlaveReg2(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_CTRL_SLV_REG2_OFFSET) + (RegOffset), (Xuint32)(Value))
#define VGA_CTRL_mWriteSlaveReg3(BaseAddress, RegOffset, Value) \
 	Xil_Out32((BaseAddress) + (VGA_CTRL_SLV_REG3_OFFSET) + (RegOffset), (Xuint32)(Value))

#define VGA_CTRL_mReadSlaveReg0(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_CTRL_SLV_REG0_OFFSET) + (RegOffset))
#define VGA_CTRL_mReadSlaveReg1(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_CTRL_SLV_REG1_OFFSET) + (RegOffset))
#define VGA_CTRL_mReadSlaveReg2(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_CTRL_SLV_REG2_OFFSET) + (RegOffset))
#define VGA_CTRL_mReadSlaveReg3(BaseAddress, RegOffset) \
 	Xil_In32((BaseAddress) + (VGA_CTRL_SLV_REG3_OFFSET) + (RegOffset))
